...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      coprocessor.RegisterWriter(cSVWriter1, filename='upper_%t.csv', freq=100, paddingamount=0, DataMode='None', HeaderType='None', EncodeAppendedData=None, CompressorType='None', CompressionLevel='None')
      
      cSVWriter2 = servermanager.writers.CSVWriter(Input=integrateVariables2)
      coprocessor.RegisterWriter(cSVWriter2, filename='lower_%t.csv', freq=100, paddingamount=0, DataMode='None', HeaderType='None', EncodeAppendedData=None, CompressorType='None', CompressionLevel='None')
